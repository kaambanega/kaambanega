...
public class ResultSetImpl implements ResultSet
{
    ...
    private boolean connCloseFlag = false;

    public ResultSetImpl(final String aliasName, final String sqlQuery) throws ClassNotFoundException, SQLException
    {
        connCloseFlag = true;
        DBConnManager dbConnManager = new DBConnManager();
        conn = dbConnManager.getMySQLConnection(aliasName);
        st = conn.createStatement();
        rs = st.executeQuery(sqlQuery);
    }

    public ResultSetImpl(final Connection conn, final String sqlQuery) throws ClassNotFoundException, SQLException
    {
        connCloseFlag = false;
        this.conn = conn;
        st = conn.createStatement();
